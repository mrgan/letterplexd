...
Adds films from your Letterboxd watchlist to your Plex watchlist, on a
schedule, on your Mac.

It syncs to the **Plex account** watchlist — the cross-server "Discover" list
tied to your Plex account — so films don't need to exist in any of your
...
`WATCHLIST_LIMIT` exists for old watchlists. If yours has hundreds of films you
...
regardless — so you don't forget it's running, and so a silent breakage doesn't
...
- It reads Letterboxd's HTML, which could break if Letterboxd changes their
